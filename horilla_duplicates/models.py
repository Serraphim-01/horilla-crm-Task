"""
Models for the horilla_duplicates app
"""
...
from horilla_duplicates.methods import limit_content_types

# Create your horilla_duplicates models here.


class MatchingRule(HorillaCoreModel):
    """
    Defines rules for matching potential duplicate records
    Similar to Salesforce's Matching Rules
    """
...
class MatchingRuleCriteria(HorillaCoreModel):
    ...
    Defines which fields to compare and how (like Salesforce)
    """
...
class DuplicateRule(HorillaCoreModel):
    ...
    Similar to Salesforce's Duplicate Rules
    """
    ...
    def get_edit_url(self):
        ...
        """
        return reverse_lazy(
            "horilla_duplicates:duplicate_rule_update_view", kwargs={"pk": self.pk}
        )
    ...
    def get_delete_url(self):
        ...
        """
        return reverse_lazy(
            "horilla_duplicates:duplicate_rule_delete_view", kwargs={"pk": self.pk}
        )
    ...
    def get_detail_view_url(self):
        ...
        """
        return reverse_lazy(
            "horilla_duplicates:duplicate_rule_detail_view", kwargs={"pk": self.pk}
        )
...
class DuplicateRuleCondition(HorillaCoreModel):
    ...
    Similar to Salesforce's Duplicate Rule Conditions
    """
